...
class TwoPanelLayoutApp(BoxLayout):
    ...
    # Ekrani qe permban dy panele navigation bar dhe content panel
    ...
    # Buttonat qe do te permbaj navigation bar
    ...
    # Pjesa e majte e Aplikacionit - Navigation Bar
    ...
    # Pjesa e djathte e Aplikacionit - Content Panel
    def _create_content_panel(self):
        ...
        self.content_panel_content = Label(
            text="WELCOME", color=(64, 181, 173)
        )
        self.content_panel.add_widget(self.content_panel_content)
        return self.content_panel

    # change the content panel label based on button clicked
...
class LoginApp(MDApp):
    ...
    def _create_login_components(self):
        ...
        # Shtimi i elementeve brenda Login 
    ...
    # Krijimi i ikones per te pare passwordin
    ...
    def login_with_provided_user_credentials(self, instance):
        ...
        if self.is_credentials_provided(username, password):
            ...
            if user is None:
                ...
                # Lidhja mes classave login app dhe twopanellayoutapp
